...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " +DBUtils.DATABASE_TABLE+ " (" +DBUtils.NOTEPAD_ID+ " integer primary" +
                " key autoincrement," +DBUtils.NOTEPAD_CONTENT+ " text," +DBUtils.NOTEPAD_TIME+ " text)");
    }
